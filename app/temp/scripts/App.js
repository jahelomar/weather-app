...
var WeatherSearch = function () {
  function WeatherSearch() {
    ...
    this.searchBtn = (0, _jquery2.default)(".search-btn");
    this.events();
  }
  ...
  _createClass(WeatherSearch, [{
    ...
    key: "keyPressHandler",
    value: function keyPressHandler(enter) {
      if (enter.keyCode == 13) {
        this.ajaxRequest();
      }
    }
    ...
    value: function ajaxRequest() {
      ...
      var city = (0, _jquery2.default)("#city").val();
      if (city != '') {
        _jquery2.default.ajax({
          url: "http://api.openweathermap.org/data/2.5/weather?q=" + city + "&units=metric&APPID=323bd50f1b78d02b6251c431f0a710d8",
          datatype: "jsonp",
          success: function success(data) {
            var display = _this.dataDisplay(data);
            (0, _jquery2.default)(".show").html(display);
            (0, _jquery2.default)("#city").val('');
          }
        });
      } else {
    ...
    key: "dataDisplay",
    value: function dataDisplay(data) {
...
var _WeatherSearch = __webpack_require__(0);

var _WeatherSearch2 = _interopRequireDefault(_WeatherSearch);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var weatherSearch = new _WeatherSearch2.default();
